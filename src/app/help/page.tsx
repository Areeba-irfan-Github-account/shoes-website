        ...
        <div className='container max-auto max-w-7xl'>
            ...
            <div className='px-6 sm:px-2 '>
                ...
                <div className='flex flex-col justify-center items-center mt-7'>
                    ...
                    <div className='border-2 morder-gray-400 px-8 py-1 rounded mb-4'>
                        <div className="flex items-center rounded-md px-1 py-1 w-40 md:w-60 focus-within:ring-2 focus-within:ring-blue-400">
                            ...
                            />
                            <CiSearch className=" mr-2 hidden lg:block" />
                        </div>
                    </div>
                </div>
                    ...
                    <div className='col-span-9'>
                        <div className='flex flex-col mt-7 '>
                            ...
                            <div className='flex flex-row mt-4 mb-5 items-start space-x-6'>
                                <Link href='/joinus' className='bg-black text-white rounded-r-full rounded-l-full px-5 py-2 sm:py-3 '>JOIN US</Link>
                                <Link href='/' className='bg-black text-white rounded-r-full rounded-l-full px-5 py-2 sm:py-3'>SHOPE NIKE</Link>
                            </div>
                            ...
                            <div className='mt-5 mb-5 text-black flex flex-col justify-center items-center sm:justify-start sm:items-start'>
                            ...
                            <div className='mt-2 mr-11 mb-32'>
                                <p className='font-bold mb-4 underline'> WHAT ARE NIKES DELIVERY OPTIONS?</p>
